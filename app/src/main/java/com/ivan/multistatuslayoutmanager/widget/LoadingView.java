package com.ivan.multistatuslayoutmanager.widget;
...
import com.ivan.multistatuslayoutmanager.R;
import com.ivan.multistatuslayoutmanager.utils.UiUtils;


/**
 *  * Created by liuwei on 2017/12/15.
...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, UiUtils.dip2px(context, 32));
